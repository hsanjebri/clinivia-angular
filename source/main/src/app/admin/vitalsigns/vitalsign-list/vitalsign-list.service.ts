...
export class DepartmentListService extends UnsubscribeOnDestroyAdapter {
  ...
  updateDepartmentList(departmentList: DepartmentList): Observable<any> {
    ...
    return this.httpClient.put(this.API_URLupdate + departmentList.vitalSignId, departmentList);
  }
  ...
  private baseUrl :string = "http://localhost:8085/Examen/vitalSigns/getAll"
  private readonly API_URLdelete = 'http://localhost:8085/Examen/vitalSigns/delete/';
  private readonly API_URLadd = 'http://localhost:8085/Examen/vitalSigns/add';
  private readonly API_URLupdate = 'http://localhost:8085/Examen/vitalSigns/update';
}