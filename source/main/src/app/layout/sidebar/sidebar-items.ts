...
export const ROUTES: RouteInfo[] = [
...

  {
    ...
    submenu: [
      ...
      {
        path: '/admin/subscription/all-subscription',
        title: 'all subscrptions',
        iconType: '',
        icon: '',
        class: 'ml-menu',
        groupTitle: false,
  ...
  },
  {
    ...
    submenu: [
      {
        path: '/doctor/pharmacy/medicine-list',
      ...
      {
        path: '/doctor/pharmacy/add-medicine',
        title: 'Add-complaint',
        iconType: '',
        icon: '',
        class: 'ml-menu',
